    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 h-16 glass border-b flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <img src="/mylogo.png" alt="Expirex logo" className="h-7 w-7 object-contain" />
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center justify-between px-4 border-b">
            <div className="flex items-center gap-3">
              <img src="/mylogo.png" alt="Expirex logo" className="w-10 h-10 rounded-xl shadow-sm object-contain" />
